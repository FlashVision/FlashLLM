#!/usr/bin/env bash
# ============================================================
#  FlashLLM — One-Command Environment Setup
# ============================================================
#
...
echo "=============================================="
echo "  FlashLLM Environment Setup"
echo "=============================================="
echo ""
...
echo ""
echo "Installing FlashLLM..."
pip install -e ".[all]" --quiet
echo "[OK] FlashLLM installed"
...
echo "    flashllm chat --model meta-llama/Llama-3.1-8B-Instruct"
echo ""
echo "  Train a model:"
echo "    flashllm train --config configs/flashllm_llama_7b_sft.yaml"
echo ""
